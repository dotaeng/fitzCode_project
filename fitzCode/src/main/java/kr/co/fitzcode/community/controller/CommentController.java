...
public class CommentController {
    ...
    private static final int GUEST_USER = -1;
    ...
    public List<Map<String, Object>> getComments(@PathVariable("postId") int postId, HttpSession session) {
        ...
        int currentUserId = (userDTO != null) ? userDTO.getUserId() : GUEST_USER;
        ...
        return rawComments.stream().map(rawComment -> {
            ...
            mappedComment.put("isLiked", currentUserId != GUEST_USER && commentService.isCommentLikedByUser(
